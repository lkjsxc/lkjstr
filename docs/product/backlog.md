...
| Item | Destination doc | Test strategy |
|------|-----------------|---------------|
| Touch/Android tab drag without snap-back | [workspace/tabs.md](workspace/tabs.md), [tab-dragging.md](../architecture/workspace/tab-dragging.md) | Playwright pointer drag on mobile viewport |
| Drop-zone feedback: center insert vs edge split | [workspace/workflows.md](workspace/workflows.md), [tab-dragging.md](../architecture/workspace/tab-dragging.md) | Playwright drag overlay class assertions |
