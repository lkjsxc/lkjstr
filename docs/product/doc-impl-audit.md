...
| Rust SQLite OPFS storage target           | [sqlite-opfs/README.md](../architecture/data/sqlite-opfs/README.md)  | documented-only | executable schema and worker not landed yet    |
