...
| Rust Custom Request parser and planner    | `crates/lkjstr-app/src/custom_request/`, `crates/lkjstr-web/src/`                               | `cargo test -p lkjstr-app -- custom_request` and WASM custom request tests |
