...
- Rust owns pure feed row geometry estimates, reservation decisions, anchor
  ...
  Timeline consume matching durable models for cached rows; relay snapshot hosts and Stats projection remain open. Reservation, unload, and LOD rules live in
