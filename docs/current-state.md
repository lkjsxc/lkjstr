...
- Relay optimizer work is now documented as a Rust/WASM target for measured
  ...
  Rust now owns pure relay read scoring and scan planning reducers, storage row
  codecs, and the relay-score WASM bridge. Current product reads still rely on
