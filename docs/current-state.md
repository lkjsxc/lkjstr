...
- Rust owns pure feed row geometry estimates, reservation decisions, anchor
  ...
  User Timeline use durable cached-row models; Home/Global/Author Context/Thread snapshots retain them. Stats projection remains open. Reservation rules live in
