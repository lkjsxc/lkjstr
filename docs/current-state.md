...
- Rust owns pure feed row geometry estimates, reservation decisions, anchor
  ...
  Home, Global, Notifications, Profile, Thread, Search, and User Timeline
  consume matching durable models for cached rows; other feed hosts and Stats projection remain open. Reservation, unload, and LOD rules live in
