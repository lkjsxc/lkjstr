...
- Which event kinds are required at launch beyond text notes, profiles, reactions, reposts, and deletes?
- How should relay hints affect publish target suggestions?
- What policy should apply to events that are well-shaped but remain unverified due to worker backlog?
