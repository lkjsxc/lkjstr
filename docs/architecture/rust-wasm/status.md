...
- Feed surfaces now have pure content-aware row geometry estimates, width
  ...
  Timeline cached rows; Home/Global/Author Context/Thread relay snapshots
  preserve cache-loaded models. Other relay snapshot hosts and browser scroll proof remain open.
