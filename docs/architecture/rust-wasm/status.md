...
- `lkjstr-app` owns startup recovery, stored tab snapshot filtering, bounded warm
  ...
  builders, Thread feed view-model/query composition, and a pure Custom Request
  parser and mode classifier.
...
- Product feed runtime wiring for Home, Global, Profile, Notifications, and
  ...
  acceptance; Custom Request, Author Context, deletion proof, and shipped TypeScript surface
