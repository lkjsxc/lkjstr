...
| Followees host glue, `src/lib/tabs/followees/**`, `src/lib/follow-graph/**`                     | `workspace/followees/**` to add                               | `lkjstr-protocol`, `lkjstr-app`, `lkjstr-relays`                   | Real kind `3`, relay discovery, retry, degraded states, and cleanup pass.                        |
