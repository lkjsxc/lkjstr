...
| `src/lib/tabs/author-context/**`, `src/lib/author-context/**`                                  | `workspace/author_context*.rs`                                 | `lkjstr-app`, `lkjstr-web`, `lkjstr-relays`, `lkjstr-storage`      | Unavailable states, no-import proof, and final gate pass.                                        |
