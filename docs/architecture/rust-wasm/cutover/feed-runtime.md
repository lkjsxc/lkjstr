...
exist and Home/Global/Notifications consume matching models for cached rows,
while other feed surfaces, browser scroll proof, and Stats projection remain open.
