...
planning from content and `imeta` tags, indexed unavailable media/reference rows
with UI attribute proof, notification repost event rows, and full FeedViewModel
