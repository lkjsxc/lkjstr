...
tests; Home, Global, and Notifications cached rows now consume matching durable
model rows. Rust Home, Global, Notifications, and Profile tabs can load host-owned
...
geometry model consumption beyond Home/Global/Notifications, deeper Stats
