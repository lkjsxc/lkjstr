...
tests; Home, Global, Notifications, and Profile cached rows now consume matching
durable model rows. Rust Home, Global, Notifications, and Profile tabs can load host-owned
...
geometry model consumption beyond Home/Global/Notifications/Profile, deeper
Stats projection, remaining feed host wiring, deletion proof, and broader
