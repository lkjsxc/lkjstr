...
tests; Home and Global cached rows now consume matching durable model rows. Rust
Home, Global, Notifications, and Profile tabs can load host-owned
...
geometry model consumption beyond Home/Global, deeper Stats projection,
remaining feed host wiring, deletion proof, and broader browser scroll
