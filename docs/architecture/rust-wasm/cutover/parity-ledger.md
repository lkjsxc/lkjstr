...
media/reference rows with UI attribute proof, normalized nprofile relay hints,
optional profile-open mention actions when a converted Rust surface already
passes a real opener, notification repost event rows, and full FeedViewModel
