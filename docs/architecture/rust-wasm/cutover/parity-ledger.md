...
User Timeline cached rows consume durable models; converted event relay
snapshots retain them. Rust Home, Global, Notifications, and Profile tabs can load
...
deeper Stats projection, header metadata relay wiring, deletion proof, and
