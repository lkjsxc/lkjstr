...
| `src/lib/search`                                                                    | feed-logic and storage-logic           | shipped SQLite token index and query helpers                | `lkjstr-app`, `lkjstr-storage`, `lkjstr-relays`                   | Rust tokenizer, local index, and NIP-50 planner are wired               |
