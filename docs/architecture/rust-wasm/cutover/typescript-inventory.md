...
| `src/lib/custom-request`                                                            | protocol-logic and relay-logic         | shipped request runner and validation display               | `lkjstr-app`, `lkjstr-protocol`, `lkjstr-relays`                  | Rust parser and run planner drive selected-relay request effects        |
