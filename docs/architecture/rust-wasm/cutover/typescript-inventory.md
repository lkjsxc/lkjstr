...
| `src/lib/identity`, `src/lib/author-context`                                        | domain-logic and view-only             | identity cache, NIP-05 state, retained Author Context loader | `lkjstr-app`, `lkjstr-storage`, `lkjstr-ui`, `lkjstr-web`          | Rust identity parity and Author Context no-import proof pass            |
