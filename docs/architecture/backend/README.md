...
- [home-query-lifecycle.md](home-query-lifecycle.md): Home attach lifecycle.
- [cache-budget.md](cache-budget.md): soft byte budget compaction.
- [transport-contract.md](transport-contract.md): local transport contract.
