...
- [sqlite-opfs/cross-tab-owner-proxy.md](sqlite-opfs/cross-tab-owner-proxy.md): design-only owner proxy plan.
...
`memory-prioritization.md` `relay-pages.md` `resource-ownership.md` `sqlite-opfs/README.md` `sqlite-opfs/app-broker.md` `sqlite-opfs/cross-tab-owner-proxy.md` `sqlite-opfs/failure-recovery.md` `sqlite-opfs/import-export.md` `sqlite-opfs/migration-map.md` `sqlite-opfs/owner-lifecycle.md`
