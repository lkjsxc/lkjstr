...
pub const STORAGE_REPOSITORY_COMMANDS: &[StorageRepositoryCommandSpec] = &[
    ...
    optimizer::FEED_ROW_HEIGHT_OBSERVATION_INSERT_COMMAND,
    optimizer::FEED_ROW_HEIGHT_OBSERVATION_PRUNE_COMMAND,
    optimizer::FEED_ROW_HEIGHT_MODEL_SELECT_COMMAND,
    optimizer::FEED_ROW_HEIGHT_MODEL_UPSERT_COMMAND,
