...
pub(super) const SETTINGS: &[SettingDefinition] = &[
    ...
    setting("publish.clientTag.enabled", "Client tag", SettingValueType::Boolean, "false", "Attach a valid NIP-89 client tag before signing public events.", NONE),
    setting("publish.clientTag.name", "Client tag name", SettingValueType::String, "lkjstr", "NIP-89 client tag display name.", NONE),
    setting("publish.clientTag.address", "Client tag address", SettingValueType::String, "", "NIP-89 kind 31990 handler coordinate.", NONE),
    setting("publish.clientTag.relay", "Client tag relay", SettingValueType::String, "", "Relay hint for the NIP-89 handler coordinate.", NONE),
    setting("timeline.showClientTags", "Show client tags", SettingValueType::Boolean, "false", "Show valid incoming NIP-89 client tag labels.", NONE),
