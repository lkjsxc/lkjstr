...
use crate::{
    ...
    notifications_feed_relay_model::output_from_snapshot,
    notifications_feed_relay_read::NotificationsRelayRead,
    relay_host::{RelaySocketCallbacks, RelaySocketHandle},
};

pub(super) fn connect_socket(read: Rc<NotificationsRelayRead>, relay: String) {
