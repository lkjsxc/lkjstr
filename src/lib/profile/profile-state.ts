...
export function emptyProfileState(): ProfileState {
  return { profile: null, posts: [], followList: undefined, loading: true, error: null, relays: [], updatedAt: null, loadingOlder: false, hasOlder: true, oldestCreatedAt: undefined, oldestCursor: undefined, newerPruned: false };
}
